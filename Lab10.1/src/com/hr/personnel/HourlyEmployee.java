...
public class HourlyEmployee extends Employee {
    ...
    /**
     * Sets the hourly rate of this employee to a specified value.
     * @param rate Hourly pay rate.
     * @throws IllegalArgumentException If rate is below Federal minimum hourly wage.
     */
    public void setRate(double rate) throws IllegalWageException {
        if(rate < FEDERAL_MINIMUM_WAGE){
            throw new IllegalWageException(String.format(
                "Illegal wage: %.2f. Federal minimum wage is %.2f", rate, FEDERAL_MINIMUM_WAGE));
        }
        this.rate = rate;
    }
